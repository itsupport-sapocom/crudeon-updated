...
function Footer() {
  return (
    <footer className='bg-white'>
      {/* Top Footer */}
      <div className='p-4 max-w-100 mx-auto grid grid-cols-[1fr_170px_170px_170px] gap-8 max-md:gap-4 max-md:grid-cols-[1fr_1fr]'>
        {/* First Row */}
        <div className="p-2 max-md:col-span-2">
          <Image src={logo} width={350} height={250} className='mb-4 h-auto w-auto object-contain' alt='footer_logo' />
          <p>Crudeon Global, a sap based company to provide asap solutions to be at top in this world</p>
        </div>
        {/* Second Row */}
        <div className="p-2">
        ...
        <div className=" p-2">
          ...
          <a  target='_blank' rel='noopener noreferrer' href='https://www.linkedin.com/in/crudeon-technologies-79382b231/' className='text-black mb-2 block transition-[transform] hover:text-primary  hover:translate-x-2'>LinkedIn</a>
      ...
      <div className="border-t p-4 flex justify-center items-center [550px]:gap-4 gap-2 max-[550px]:flex-col text-secondary">
        <p >@ {new Date().getFullYear()} Crudeon Global. All rights reserved</p>
        <div className=' flex '>
          ...
          <a href='https://www.linkedin.com/in/crudeon-technologies-79382b231/' target='_blank' rel="noopener noreferrer" className='w-9 h-9 bg-secondary rounded-full p-2 mr-2 grid place-items-center hover:bg-primary' aria-label="linked in">
