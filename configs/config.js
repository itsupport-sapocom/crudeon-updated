...
export const MAIN_URL = 'https://crudeonglobal.com';
...
export const whyChooseUsData = [
    ...
    {
        name: 'Breadth & Depth',
        description: 'Our team at Crudeon possesses extensive industry experience in the Metal & Mining and Oil & Gas sectors. We have deep knowledge and understanding of the specific challenges, requirements, and best practices within these industries.',
...
export const reviewData = [
    {
        ...
        review: "CRUDEON experts played a key role in implementation and launch of functionality of new commodity price engine CPE/ CPF in one of the biggest mining projects starting from configuration and supporting developments, testing and defect resolution. From the outset, the team demonstrated an impressive level of professionalism and expertise. Their attention to detail and willingness to work closely with us to ensure that our needs were met were truly appreciated. The team's communication was excellent, and we always felt informed and involved throughout the project. We are grateful for contribution of CRUDEON colleagues and hope for future perspective cooperation.",
        image: reviewPerson1,
    },
    {
        name: 'Dominic M Pinili',
        position: 'Head of Solutions Delivery',
        review: "I want to extend my gratitude to each member of the Crudeon team for their hard work, professionalism, and dedication. It is because of your collective efforts that we now have a top-notch solution that meets our requirements and exceeds our expectations. We look forward to continuing our partnership with Crudeon and working together on future projects. Without a doubt, we highly recommend the Crudeon team to any organization seeking excellence in project delivery.Thank you once again for your outstanding work.",
        image: reviewPerson2,
    },
...
export const serviceSolution = [
    ...
    'CRUDEON strives to establish a strong organization and contribute to global SAP projects.'
]
...
export const industryOilGasSuccessData = [
    ...
    'Optimization and improved profitability through Crudeon modules.',
...
export const industryOilGasFutureData = [
    {
        ...
        description: 'Crudeon’s solution helps oil and gas companies manage complex pricing models by considering various parameters.',
    ...
    },
    {
        ...
        description: 'Observe a visible increase in profits with Crudeon’s solution for retail station reconciliations that helps oil and gas companies optimize their retail operations',
