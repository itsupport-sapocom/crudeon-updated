...
export default function Agriculture() {
  return (
    <>
      <SetHeaders title='Agriculture Industry | Crudeon' />
      ...
      <AboutIndustry
        ...
        description="Are you in the agriculture industry and struggling to keep track of prices and logistics? Look no further than Crudeon's Agricultural Contract Management (ACM) module!"
        image={industryAbout}
