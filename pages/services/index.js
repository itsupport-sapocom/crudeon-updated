...
function Services() {
  return (
    <>
      <SetHeaders title='Services | Crudeon' />
      <HeaderBanner heading='Empowering Global SAP Projects - CRUDEON Consulting & Talent Solutions' para='Integrated platform for Oil & Gas, Metal & Mining to facilitate digital transformation using SAP business processes for future
sustainability & growth. ' bgImg={serviceBanner} />
      ...
      <section className='w-full p-4 py-8 md:py-10 ' >
        <div className='max-w-900 mx-auto grid max-md:grid-rows-[1fr_300px] md:grid-cols-[1fr_300px] rounded-lg bg-grey p-4 md:p-6 text-black gap-4'>
          <div>
            <h2 data-aos='flip-up' className='text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-primary from-30%  to-secondary to-90% mb-4 md:mb-8 max-w-[550px]'>Revolutionize Your Business Operations with CRUDEON&apos;s SAP Services</h2>
      ...
      <section className='w-full p-4 py-8 md:py-10 bg-gradient-to-r from-primary to-secondary text-white'>
        <div className='max-w-1200 mx-auto'>
          ...
          <h2 data-aos='fade-up' data-aos-delay='200' className='text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50 mb-8'>Advantages in working with CRUDEON</h2>
          {/* Desktop View card */}
          <div className="max-w-1000 mx-auto grid grid-cols-auto-3 gap-4 md:gap-8 justify-items-center max-md:hidden">
            {
