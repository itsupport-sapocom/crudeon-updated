...
export default function Home() {
  ...
  return (
    <>
      {/* Header Configs */}
      <SetHeaders title='Crudeon | A SAP based company to provide asap solutions to be at top in this world | Home Page' />
      ...
      <section className='w-full p-4 md:py-8 bg-grey' >
        <div className='max-w-1200 mx-auto flex gap-10 flex-wrap '>
          <div className="flex-1">
            ...
            <h2 data-aos='fade-up' data-aos-delay='200' className='text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-primary from-30%  to-secondary to-90% mb-4'>CRUDEON</h2>
            ...
            <p data-aos='fade-up' className='text-black mb-6'>Crudeon is an emerging SAP consulting, training, and talent recruitment industry leader. The gateway to unleashing the boundless potential of your business through the captivating realm of SAP digital transformation! </p>
      ...
      <section className='w-full p-4 md:py-8 bg-grey' >
        <div className='max-w-1200 mx-auto flex gap-4 flex-wrap '>
          <div className="md:flex-1">
            ...
            <h2 data-aos='fade-up' data-aos-delay='200' className='text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-primary from-30%  to-secondary to-90% mb-4 max-w-[550px]'>With our strong global presence and unwavering commitment to delivering growth-oriented and efficient SAP solutions, CRUDEON enables businesses worldwide to thrive.</h2>
