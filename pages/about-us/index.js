      ...
      <section className='w-full p-4 pb-10 pt-24 md:pt-32  bg-gradient-to-r from-primary to-secondary' >
        <div className='max-w-1200 mx-auto flex gap-10 flex-wrap text-white'>
          <div className="flex-1">
            ...
            <h2 data-aos='fade-up' data-aos-delay='200' className='text-3xl font-semibold mb-2'>CRUDEON Global</h2>
            <p data-aos='fade-up' data-aos-delay='300' className='mb-6 opacity-70'>CRUDEON acknowledges the potency of SAP technology and its impact on businesses. We are enthusiastic about delivering bespoke solutions that meet our client&apos;s requirements. Our team of professionals is available to provide unwavering support throughout your journey.</p>
          ...
          <div className="grid md:grid-rows-[1fr_1fr] gap-8 text-white">
            ...
            <div className='flex gap-8 justify-center flex-wrap'>
              <div >
                ...
                <p className='text-base opacity-70'>Founder & CEO, Crudeon Global</p>
              </div>
              <div >
                ...
                <p className='text-base opacity-70'>Co-Founder & Director, Crudeon Global</p>
              </div>
            </div>
            {/* Message side */}
          ...
          <div className='grid md:grid-cols-6 max-md:grid-rows-6'>
            ...
            <div className="bg-red w-full grid md:grid-rows-[1fr_1px_1fr] max-md:grid-cols-[1fr_1px_1fr]">
              ...
              <div className="p-4 px-2 text-center flex flex-col justify-center items-center">
                <p className='mb-3 font-semibold leading-tight'>Crudeon was founded</p>
