  ...
  if (req.method = 'POST') {
    try {
      ...
      const info = await transporter.sendMail({
        ...
        subject: `Crudeon Form Submitted Successfully!`, // Subject line
        html: `<h1>Crudeon Form Submitted Successfully</h1>
        <div>
          ...
          <p>Any views expressed in this message are those of the individual sender, except where the sender specifies and with authority, states them to be the views of the CRUDEON Technologies</p>
        </div>`
      });
