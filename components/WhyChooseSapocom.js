        ...
        <>
            ...
            <section className='w-full p-4 max-md:py-8 py-10 max-w-1200 mx-auto ' >
                <div className='flex items-center flex-col mb-10 max-md:mb-5 text-center'>
                    ...
                    <h2 data-aos='flip-right' data-aos-delay='100' className='md:text-4xl text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-primary from-30%  to-secondary to-90% mb-2'>Why Choose CRUDEON ?</h2>
